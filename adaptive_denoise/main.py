...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='denoise', help='dataset_name')
    parser.add_argument('--iteration', type=int, default=110000, help='The number of training iterations')
    ...
    parser.add_argument('--print_freq', type=int, default=2, help='The number of image_print_freq')  # TODO before is 1000
    ...
    parser.add_argument('--supervised_weight', type=float, default=2, help='Weight for supervised loss')
    ...
    parser.add_argument('--star_checkpoint_dir', type=str, default='denoise_output/checkpoints', help='Directory name to save the checkpoints')
    parser.add_argument('--unet_checkpoint_dir', type=str, default='slice_output/merge_slice_9/checkpoints', help='Directory name to save the checkpoints')
    parser.add_argument('--haze_cycle_checkpoint_dir', type=str, default='translate_output/haze_transform/checkpoints', help='Directory name to save the checkpoints')
    parser.add_argument('--rain_cycle_checkpoint_dir', type=str, default='translate_output/rain_transform/checkpoints', help='Directory name to save the checkpoints')
    parser.add_argument('--dark_cycle_checkpoint_dir', type=str, default='translate_output/dark_transform/checkpoints', help='Directory name to save the checkpoints')
...
def check_args(args):
    # --checkpoint_dir
    check_folder(args.star_checkpoint_dir)
