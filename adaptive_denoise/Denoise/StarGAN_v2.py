...
class StarGAN_v2():
    def __init__(self, args):
        ...
        self.sample_dir = os.path.join('star_output', args.dataset, args.sample_dir)
        check_folder(self.sample_dir)

        self.checkpoint_dir = os.path.join('star_output', args.dataset, args.checkpoint_dir)
        check_folder(self.checkpoint_dir)

        self.log_dir = os.path.join('star_output', args.dataset, args.log_dir)
        check_folder(self.log_dir)

        self.result_dir = os.path.join('star_output', args.dataset, args.result_dir)
