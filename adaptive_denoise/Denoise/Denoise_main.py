...
def parse_args():
    ...
    parser.add_argument('--result_dir', type=str, default='sample_testing',
                        help='Directory name to save the generated images')
    parser.add_argument('--log_dir', type=str, default='summaries',
                        help='Directory name to save training logs')
    parser.add_argument('--sample_dir', type=str, default='samples_training',
...
def check_args(args):
    # --checkpoint_dir
    checkpoint_dir = os.path.join('../denoise_output', args.dataset, args.checkpoint_dir)
    check_folder(checkpoint_dir)

    # --result_dir
    samples_testing = os.path.join('../denoise_output', args.dataset, args.result_dir)
    check_folder(samples_testing)

    # --result_dir
    summaries = os.path.join('../denoise_output', args.dataset, args.log_dir)
    check_folder(summaries)

    # --sample_dir
    samples_training = os.path.join('../denoise_output', args.dataset, args.sample_dir)
    check_folder(samples_training)
